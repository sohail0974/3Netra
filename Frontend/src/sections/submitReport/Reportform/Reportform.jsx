    ...
    <div className='page-container'>
       ...
       <form className='report_form' onSubmit={handleSubmit} >
                ...
                {suggestions.length > 0 && (
                  <ul className='suggestion_list'>
                    {suggestions.map((suggestion) =>(
                      <li key={suggestion.place_id} className='suggestion_item'
            ...
            <div className="map_panel">
               <MapContainer center={formData.location} zoom={13} style={{height: '100%',width:'100%'}}>
                <TileLayer url = "https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png" /> 
                  <Marker position={formData.location} draggable={true} eventHandlers={eventHandlers} ref={markerRef} />
        ...
        <div className="form_section">
          ...
          placeholder='Describe what you saw in detail' onChange={handleInputChange} required />
        </div>
         <div className="form_section">
